...
public:
	...
	virtual void StartZoom(const FInputActionValue& Value) = 0;
	virtual void StopZoom(const FInputActionValue& Value) = 0;
	//virtual void UpdateZoom(const FInputActionValue& Value) = 0;
};
